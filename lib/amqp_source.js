...
AmqpTasksSource.prototype.onIssueQueue = function onIssueQueue(action, cb, requiresDeclaration, autoDelete) {
  var self = this;
  ...
  wrapper._queue = this.connection.queue(action, {
    autoDelete: autoDelete,
    durable: !autoDelete,
    noDeclare: !requiresDeclaration
  ...
  wrapper._queue.once('queueBindOk', function bindOk() {
